...
public class PrecioTotal {
    protected Double totalComputadores = 0.0;
    protected Double totalComputadoresPortatiles = 0.0;
    protected Double totalComputadoresMesa = 0.0;
    protected Computadores[] listaComputadores;
    // Constructor
